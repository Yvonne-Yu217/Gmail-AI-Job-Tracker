...
def normalize_status(raw_status):
    ...
    declined_phrases = [
        ...
        "more closely meet our requirements", "better fit for", "different direction",
        "wish you success", "wish you the best", "best of luck", "good luck",
        "thank you for your interest", "appreciate your interest", "regret to inform",
...
if __name__ == '__main__':
    try:
        ...
        process_all_emails(limit=None, since_hours=None)  # Process all emails at once
